        ...
        <div class="navigation-area">
          ...
          <nav class="navbar p-0">
            <ul class="navigation sub-menu w-100 mb-0 navbar-nav">
              <li class="dropdown">
                <a href="index.php" class="<?php if($crtPath == 'index'){echo 'active';}?>"><i class="fa fa-database mr-2"></i>Dashboard</a>
              </li>
              <li class="dropdown">
                <a href="#" class="<?php if($crtPath == 'title_logo' || $crtPath == 'social' || $crtPath == 'copyright'){echo 'active';}?>" data-toggle="dropdown" aria-expanded="false">
              ...
              <li class="dropdown">
                <a href="#" class="<?php if($crtPath == 'pageadd' || $crtPath == 'pagelist'){echo 'active';}?>" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-pager mr-2"></i>Pages</a>
                <ul class="dropdown-menu">
              ...
              <li class="dropdown">
                <a href="#" class="<?php if($crtPath == 'categoryadd' || $crtPath == 'categorylist'){echo 'active';}?>" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-database mr-2"></i>Category</a>
                <ul class="dropdown-menu">
              ...
              <li class="dropdown">
                <a href="#" class="<?php if($crtPath == 'slideradd' || $crtPath == 'sliderlist'){echo 'active';}?>" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-database mr-2"></i>Slider</a>
                <ul class="dropdown-menu">
              ...
              <li class="dropdown">
                <a href="#" class="<?php if($crtPath == 'postadd' || $crtPath == 'postlist'){echo 'active';}?>" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-database mr-2"></i>Posts</a>
                <ul class="dropdown-menu">
              ...
              <li>
                <a href="adduser.php" class="<?php if($crtPath == 'adduser'){echo 'active';}?>"><i class="fa fa-user mr-2"></i>Add User</a>
              </li>
              <li>
    ...
    <nav class="navbar navbar-expand fixed-top p-0">
      ...
      <ul class="navbar-nav align-items-center pr-3 nav-right">
        ...
        <li class="nav-item dropdown language">
          <a href="" class="nav-link" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-flag"></i>
          </a>
          <ul class="dropdown-menu">
